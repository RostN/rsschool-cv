...
function createCard(data){
    ...
    data.forEach (item => {
        ...
        let article = card.querySelector('arcticle');
        if (article) article.classList.add('cardCategory'); //Добавляем категорю в качестве класса
